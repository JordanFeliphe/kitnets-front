...
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious } from '@/app/shared/components/ui/pagination'
import {
  MoreVertical,
  Download,
  Receipt,
        ...
        {data.map((boleto) => (
          <div key={boleto.id} className="rounded-lg border bg-card p-4">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="ml-2"><StatusBadge status={boleto.status} /></div>
            </div>
