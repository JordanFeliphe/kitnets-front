...
const chartConfig = {
  ...
  desktop: { 
    label: "Receitas", 
    color: "hsl(var(--chart-1))" // Teal primary
  },
  mobile: { 
    label: "Ocupação", 
    color: "hsl(var(--chart-2))" // Teal secondary
  },
    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          <CardTitle>Receitas e Ocupação</CardTitle>
          <CardDescription>Análise comparativa dos últimos meses</CardDescription>
        </div>
