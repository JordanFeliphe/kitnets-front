...
import { User, UserRole, UserStatus } from "@/app/shared/types"
...
const statusVariants: Record<UserStatus, "success" | "secondary" | "destructive"> = {
  ACTIVE: "success",
  INACTIVE: "secondary",
  BLOCKED: "destructive",
}

const roleVariants: Record<UserRole, "default" | "info" | "success"> = {
  ADMIN: "default",
  MANAGER: "info",
  RESIDENT: "success",
}
