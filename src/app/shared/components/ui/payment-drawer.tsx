...
function PaymentDrawerContent({ payment, onDownloadReceipt, onDownloadInvoice, onEmailReceipt, onCopyDigitableLine, onDispute }: {
  ...
  const diasAtraso = payment.diasAtraso || calculateDaysLate(payment.vencimento, payment.pagamento ?? undefined)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {payment.desconto && payment.desconto > 0 && (
                <div>
                  ...
                  <p className="text-base font-semibold text-custom-orange-600">
