...
import { FileText, Calendar, DollarSign, Building, Users, RefreshCw } from "lucide-react"
...
const statusVariants: Record<LeaseStatus, "statusActive" | "dangerAlt" | "statusDraft" | "warningAlt"> = {
  ACTIVE: "statusActive",
  EXPIRED: "dangerAlt",
  TERMINATED: "statusDraft",
  PENDING: "warningAlt",
}
