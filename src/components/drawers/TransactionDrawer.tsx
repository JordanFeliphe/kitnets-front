...
import { Transaction, TransactionStatus, TransactionType, PaymentMethod } from "@/types"
...
const statusVariants: Record<TransactionStatus, "warningAlt" | "statusActive" | "statusDraft" | "dangerAlt"> = {
  PENDING: "warningAlt",
  PAID: "statusActive",
