...
import { Building, MapPin, DollarSign, Users, Wrench, Eye } from "lucide-react"
...
const statusVariants: Record<UnitStatus, "statusActive" | "infoAlt" | "dangerAlt" | "warningAlt"> = {
  AVAILABLE: "statusActive",
  OCCUPIED: "infoAlt", 
  MAINTENANCE: "dangerAlt",
  RESERVED: "warningAlt",
}
