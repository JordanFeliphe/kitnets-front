        ...
        cell: ({ row }) => {
          ...
          return (
            <button
              ...
              className="text-left font-medium text-teal-600 hover:text-teal-700 hover:underline dark:text-teal-400 dark:hover:text-teal-300"
              role="button"
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className={cn(
              "text-sm font-medium",
              isOverdue && row.original.status !== "Pago" && "text-red-600 dark:text-red-400"
            )}>
              {vencimento}
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className="cursor-pointer hover:bg-teal-50/50 dark:hover:bg-teal-950/50"
                  role="button"
                  tabIndex={0}
